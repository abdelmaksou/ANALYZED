...
(function (global, factory) {
    ...
    async function downloadSvg(svg, svgName, options) {
        ...
        Promise.all(image_promises).then(async function() {
            //get svg string
            svgString = setupSvg(svgElement, svg);
            ...
            await save({
                ...
                writeFile({ contents: svgString, path: path }, { dir: BaseDirectory.Home });
                ...
                if (extension != "svg") {
                    ...
                    bottom_data.textContent = "Pie Chart is Saved Successfully.";
